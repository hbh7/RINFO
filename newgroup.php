            ...
            <form id="form" method="post" action="" role="form" enctype="multipart/form-data">
                ...
                <div class="controls">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tagline" type="text" name="text" class="form-control" required="required" data-error="Tagline is required." value="<?php if (isset($_POST['tagline'])) echo $_POST['tagline']; ?>">
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
